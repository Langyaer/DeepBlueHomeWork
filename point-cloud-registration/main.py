...
def main(
    ...
    # write output:
    io.write_output(
        os.path.join(input_dir, 'reg_result_avenue.txt'),
        df_output
    )
...
if __name__ == '__main__':
    ...
    # /usr/bin/python3.6 /home/demo/DeepBlue/point-cloud-registration/main.py -i /home/demo/DeepBlue/registration_dataset/ -r 0.5 -b 11